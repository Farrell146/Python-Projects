  ...
  try:
    with open("data/bigarraylist.dat", 'r') as f:
        ...
        for y in range(len(catlist)):
           names.append(catlist[y].getName())
        a=" ".join(names)
        print(a)
        print()
        ...
        for cheapcat in range(len(catlist)):
           if catlist[cheapcat].getCost() < 26.00:
        ...
        for k in range(len(catlist)):
           Costs.append(catlist[k].getCost())
        a="".join(str(Costs))
        print(a)
        print()
        ...
        for eat in range(len(catlist)):
           if catlist[eat].getWeight()>15:
              fat.append(catlist[eat].getName())
        print("Fat Cats:")
        a=" ".join(fat)
        print(a)
